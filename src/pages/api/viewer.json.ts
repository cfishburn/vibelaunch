...
import { jsonResponse, serverErrorJson, unauthorizedJson } from '../../lib/server/http';
...
export const GET: APIRoute = async (context) => {
	try {
		...
		console.error('[viewer.json] Unable to build viewer payload.', error);
		return serverErrorJson('Unable to load the member demo payload.');
	}
};
